		...
		<div className="loginpage">
			<form className="loginform">
				...
				<section className="qrcode">
					...
					<h2 className="qrcode-text">Log in with QR Code</h2>
					<div className="qrcode-subtext ">Scan this with the <strong>Discord mobile app </strong>to log in instantly</div>
				</section>
			</form>
		</div>
	)
